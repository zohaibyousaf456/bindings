...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[260px_minmax(0,1fr)] bg-gradient-to-br from-blue-50 to-purple-50">
      <aside className="hidden lg:block border-r border-gray-200 bg-white/90 supports-[backdrop-filter]:bg-white/70 backdrop-blur">
        <Sidebar />
      </aside>
